export const faqs = [
  {
    ...
    items: [
      ...
      {
        q: "How do I find the right Swahili teacher for me?",
      ...
      {
        q: "What equipment do I need for online Swahili lessons?",
      ...
      {
        q: "How much do Swahili lessons cost?",
  ...
  },
  {
    ...
    items: [
      ...
      {
        q: "Do I need formal teaching qualifications to apply?",
      ...
      {
        q: "Can I set my own teaching schedule?",
  ...
  },
  {
    ...
    items: [
      {
        q: "What video platforms are used for online Swahili lessons?",
